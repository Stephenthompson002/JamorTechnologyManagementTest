...
@font-face {
  ...
  <nav id="navScroll" class="navbar navbar-expand-lg navbar-light fixed-top" tabindex="0">
    <div class="container">
      ...
      <div class="col=1" id="navbarSupportedContent">
       <a href="register.php" class="btn btn-dark btn-xl shadow me-1 rounded-0 my-1">Sign Up</a>
      </div>
      </div>
  </nav>
            ...
            <div class="mb-3">
              ...
              Forget password?
              <p> Kindly Contact <strong>Administrator</strong>. 
              <p>Thank You.</label>
              </div>  
              <div class="col=1" id="navbarSupportedContent">
       <a href="admin/login.php" class="btn btn-primary btn-block btn-flat">Admin login</a>
      </div>
      <br>
      <div class="col=1" id="navbarSupportedContent">
       <a href="Admin_register.php" class="btn btn-primary btn-block btn-flat">Admin Signup</a>
      </div>
              </form>
            </main>
          </div>
